    ...
    <div class="container-fluid">
        ...
        <div class="content mt-5 mb-5 pb-5">
            ...
            <div class="box-info-user ">
                <div>
                    <div class="mt-5"><span class="text-topic">Title:</span>
                    ...
                    <div class="mt-4"><span class="text-topic">Date of birth:</span>
                        <span class="text-content"><?php echo htmlspecialchars($dob); ?></span>
                    </div>
                    <div class="mt-4 mb-5"><span class="text-topic">Tel:</span>
                        <span class="text-content"><?php echo htmlspecialchars($phone); ?></span>
                    </div>
                </div>
                <a href="edit_user2.php">
                    <div class="d-flex justify-content-center align-items-center">
                        <button type="sumbit" class="btn-edit mt-4 mb-4"><i class="fa-solid fa-pen-to-square"></i> Edit</button>
                    </div>
                </a>
            </div>

            <div class="text-topic mt-5 pt-5 d-flex justify-content-center align-items-center mb-3">Car Infomation</div>
            <div class="box-info-user ">
                <div>
                    <div class="mt-5"><span class="text-topic">Car type:</span>
                        <span class="text-content"><?php echo htmlspecialchars($car_type); ?></span>
                    </div>
                    <div class="mt-4"><span class="text-topic">Car registration:</span>
                        <span class="text-content"><?php echo htmlspecialchars($car_registration); ?></span>
                    </div>
                    <div class="mt-4"><span class="text-topic">Car brand:</span>
                        <span class="text-content"><?php echo htmlspecialchars($car_brand); ?></span>
                    </div>
                    <div class="mt-4 mb-5"><span class="text-topic">Car model:</span>
                        <span class="text-content"><?php echo htmlspecialchars($car_model); ?></span>
                    </div>

                </div>
                <a href="edit_user3.php">
                    <div class="d-flex justify-content-center align-items-center">
                        <button type="sumbit" class="btn-edit mt-4 mb-4"><i class="fa-solid fa-pen-to-square"></i> Edit</button>
                    </div>
                </a>
