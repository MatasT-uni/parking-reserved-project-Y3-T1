...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-center mt-4 mb-4">
            <div class="col-lg-auto col-md-12 d-flex justify-content-center align-items-center mt-4">
                <div>
                    <div class="col-lg-4 col-md-12 mb-4 img-btn"><img class="img" src="img/11.jpg" alt=""></div>
            ...
            <div class="col-lg-auto col-md-12 d-flex justify-content-center align-items-center mt-4">
                <div>
                    <div class="col-lg-4 col-md-12 mb-4 img-btn"><img class="img" src="img/22.jpg" alt=""></div>
                    <div class="col-lg-4 col-md-12 mb-3 text-center text-place ">Centarl Plaza</div>
                    <div class="col-lg-4 col-md-12 mb-5 d-flex justify-content-center" style="width: 100%;">
                        <button class="view-btn">view</button>
                    </div>
                </div>
            ...
            <div class="col-lg-auto col-md-12 d-flex justify-content-center align-items-center mt-4">
                <div>
                    <div class="col-lg-4 col-md-12 mb-4 img-btn"><img class="img" src="img/44.jpg" alt=""></div>
                    <div class="col-lg-4 col-md-12 mb-3 text-center text-place ">MBK Center</div>
                    <div class="col-lg-4 col-md-12 mb-5 d-flex justify-content-center" style="width: 100%;">
                        <button class="view-btn ">view</button>
                    </div>
                </div>
