...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="searchpage.php" active><i class="fa-solid fa-magnifying-glass"></i> Search</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        ...
        <div class="content mt-5 mb-5 pb-5">
            <div class="text-content">Choose payment method below:</div>
            <div class="row mt-5 d-flex justify-content-center align-items-center">
                <button class="col-xl-3 col-lg-3 col-md-12 mx-3 pt-2 pb-2 box-payment box-payment-md
                 d-flex flex-column justify-content-center align-items-center">
                    <div><img src="img/creditcard.png" class="pic-payment1"></div>
                    <div class="text-payment mt-2">Credit Card</div>
                </button>
                <button class="col-xl-3 col-lg-3 col-md-12 mx-3 pt-2 pb-2 box-payment box-payment-md
                 d-flex flex-column justify-content-center align-items-center">
                    <div><img src="img/qrcodepayment.png" class="pic-payment2"></div>
                    <div class="text-payment mt-2">QR Code</div>
                </button>
                <button class="col-xl-3 col-lg-3 col-md-12 mx-3 pt-2 pb-2 box-payment box-payment-md
                 d-flex flex-column justify-content-center align-items-center">
                    <div><img src="img/banking.png" class="pic-payment2"></div>
                    <div class="text-payment mt-2">Internet Banking</div>
                </button>
                <a href="paymentsuccess.php">
                    <div class="col-12 pt-4 d-flex justify-content-center align-items-center"> <button class=" mt-5 btn-confirm">
                            <i class="fa-solid fa-check"></i> Confirm</div>
                </a>
