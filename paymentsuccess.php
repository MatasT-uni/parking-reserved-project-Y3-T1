...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div class="container-fluid">
        ...
        <div class="content mt-5 mb-5 pb-5">
            <div class="text-content d-flex justify-content-center align-items-center mt-5 mb-5 pt-3">
                <i class="fa-solid fa-circle-check icon-payment-s text-success"></i>

            </div>
            <div class="text-thanks d-flex justify-content-center align-items-center mt-5">Thank you !</div>
            <div class="text-content d-flex justify-content-center align-items-center mt-3"> Your Booking has been successfully processed
            </div>
            <a href="bookingpage.php">
                <div class=" pt-4 d-flex justify-content-center align-items-center"> <button class=" mt-5 btn-confirm">
                        <i class="fa-solid fa-chevron-right"></i> Go To Booking Page</div>
            </a>
        </div>
...
<footer>
    <div class="p-0 m-0 footer">
        <div class="footer-content ">
            <div class="row d-flex justify-content-center align-items-center icon-footer" style="width: 90%;">
            ...
            <div class="row d-flex justify-content-center align-items-center text-footer mt-2" style="width: 90%;">
